...
export function DashboardLayout() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
      <header className="sticky top-0 z-40 w-full glass-panel border-b rounded-none shadow-sm">
      ...
      <main className="flex-1 container mx-auto p-4 md:p-6 animate-fade-in-up">
        <Outlet />
      </main>
    </div>
  )
